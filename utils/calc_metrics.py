...
import util_logger
import util_image as util
import util_metrics as metrics
...
def main(args):
    ...
    SETUP LOGGER
    """
    util_logger.logger_info("Fast-Super-resolution", log_path=os.path.join(args.sr_dir, args.submission_id, "results", f"Submission_{args.submission_id}.txt"))
    logger = logging.getLogger("Fast-Super-resolution")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sr-dir", type=str)
